...
def build_query_graph(graph, embedding_size=500, embedding_path=None, token2idx=None,
                      ...
                      convolutional_kernels=16, filter_extension=3, fix_embeddings=False,
    ...
    convolutional_layer = Convolution1D(input_dim=embedding_size, nb_filter=convolutional_kernels,
                                        filter_length=filter_extension, border_mode='valid', activation='relu',
...
def experiment(train_questions, train_tensor, train_answers,
               ...
               input_dropout_rate=0.25, dropout_rate=0.5, l1=None, l2=None, convolutional_kernels=16,
               filter_extension=3, optimizer='adadelta', loss='mse', n_predictors=80,
    ...
    graph = build_query_graph(graph, embedding_size=embedding_size, embedding_path=embedding_path, token2idx=token2idx,
                              ...
                              convolutional_kernels=convolutional_kernels, filter_extension=filter_extension,
...
def main(argv):
    ...
    parser.add_argument('--max-features', type=int, nargs='+', default=[100000], help='Max num of words in dictionary')
    ...
    parser.add_argument('-k', '--conv-kernels', type=int, nargs='+', default=[16], help='Num convolutional kernels')
    parser.add_argument('-x', '--filter-extension', type=int, nargs='+', default=[3], help='Filter length')
    ...
    convolutional_kernels_list = args.conv_kernels
    filter_extension_list = args.filter_extension
    l1_list = args.l1
    l2_list = args.l2
    ...
    max_features_list = args.max_features
    ...
    configuration_space = dict(optimizer=optimizer_list,
                               ...
                               convolutional_kernels=convolutional_kernels_list,
                               filter_extension=filter_extension_list,
